	...
	<div class="container bg-white">
		...
		<div class="row">
            ...
            <ul class="nav rounded shadow">
                <li class="nav-item btn btn-success m-3" ><a href="HODLeaves.jsp" class="nav-link text-light active">Home</a></li>
     	...
     	<%
     		...
     		ResultSet rs = st.executeQuery("SELECT * FROM cl INNER JOIN onduty ON cl.Faculty_ID = onduty.Faculty_Id;");
     		while(rs.next()){
     			%>
     		     <tr>
     		        <td><%=rs.getInt(1) %></td>
