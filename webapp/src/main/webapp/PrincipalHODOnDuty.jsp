	...
	<div class="container bg-white">
		...
		<div class="row">
            ...
            <ul class="nav rounded shadow">
                ...
                <li class="nav-item btn btn-success m-3" ><a href="PrincipalHODLeaves.jsp" class="nav-link text-light active">Back</a></li>
     	...
     	<%
     		...
     		ResultSet rs = st.executeQuery("select * from onduty where Designation='HOD' and status='pending'");
     		while(rs.next()){
     			%>
     		     <tr>
     		        <td><%=rs.getInt(1) %></td>
     		        ...
     		        <td><a href="PrincipalOnDutyApprov.jsp?fid=<%=rs.getString(2)%>&status=<%="Approve" %> &LID=<%=rs.getInt(1) %>" class="btn btn-success" >Approve</a>
