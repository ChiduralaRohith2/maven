	...
	<div class="container bg-white">
		...
		<div class="row" style="background-color:orange">
			<ul class="nav rounded shadow" style="background-color: orange;">
                ...
                <li class="nav-item btn btn-success m-3" ><a href="login.html" class="nav-link text-light active">Admin</a></li>
		...
		<div class="row"> 
        	...
        	<h4>Waiting for Approval....?</h4>
            		<a href="Leaves.jsp" style="align:center;"><button class="btn btn-lg faculty">Ok</button></a>
    		</div>
    		<div class="col-4"></div>
		</div>
	</div>
