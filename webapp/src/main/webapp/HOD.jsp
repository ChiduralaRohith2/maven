	...
	<div class="container bg-white">
		...
		<div class="row">
            <ul class="nav shadow" style="background-color: orange;">
                ...
                <li class="nav-item btn btn-success m-3" ><a href="HODLeaves.html" class="nav-link text-light active">ApplyLeave</a></li>
                <li class="nav-item btn btn-success m-3" ><a href="facultyLeaves.html" class="nav-link text-light active">Applied Faculty Leaves</a></li>
