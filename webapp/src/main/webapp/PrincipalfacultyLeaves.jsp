...
<body>
	<div class="container bg-white">
		...
		<div class="row"> 
        	...
        	<h2><u>Leaves</u></h2><br>
            	<a href="PrincipalCL.jsp"><button type="button" class="btn btn-primary btn-lg">Casual Leave/C.C.L</button></a><br><br>
            	<a href="PrincipalOnDuty.jsp"><button type="button" class="btn btn-primary btn-lg">On-Duty</button></a>
    		</div>
    		<div class="col-4"></div>
		</div>
	</div>
