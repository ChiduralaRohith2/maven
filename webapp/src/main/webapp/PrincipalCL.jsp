     		...
     		while(rs.next()){
     			%>
     		     <tr>
     		        ...
     		        <td><a href="PfacultyCLLeaveApprove.jsp?fid=<%=rs.getString(2)%>&status=<%="Approve" %> &LID=<%=rs.getInt(1) %>" class="btn btn-success" >Approve</a>
     		        	<a href="PfacultyCLLeaveReject.jsp?fid=<%=rs.getString(2)%>&status=<%="Reject" %>" class="btn btn-danger" >Reject</a>
